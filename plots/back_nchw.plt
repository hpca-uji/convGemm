...
plot ARG1 using (1):(2*$1*$2*$3*1e-9/($8+$9+$10)):(0.25):(sprintf("%6d", $3)) title 'trans+BLIS+im2col', \
     ARG1 using (1.5):(2*$1*$2*$3*1e-9/$11):(0.25):(sprintf("%6d", $3)) title 'convGEMM NCHW back'
