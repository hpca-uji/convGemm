...
plot ARG1 using (  600):1 ls 1 title 'BLIS', \
     ...
     ARG2 using (  800):1 ls 2 title 'Small buffer', \
     ...
     ARG3 using ( 1000):1 ls 3 title 'Large buffer', \
     ...
     ARG4 using ( 1200):1 ls 4 title 'Large buffer seq.', \
