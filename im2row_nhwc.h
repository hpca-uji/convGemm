...
void pack_CB_nhwc(char orderM, char transM, int mc, int nc, const float *M, int ldM, float *Mc, int RR, const float *in, const convol_dim *dim, int start_row, int start_col);
