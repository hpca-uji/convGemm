...
void post_row2im_nhwc(int m, int n, float *rows, float beta, float *out, int ldout, const convol_dim *d, const float *bias_vector, int start_row, int start_col, bool last);
