...
void post_row2im_nhwc(int m, int n, const float *rows, float beta, float *out, int ldout, const convol_dim *d, const float *bias_vector, int start_row, int start_col, bool last);

void add_bias_nhwc(int mr, int nr, const float *Cc, float beta, float *C, int ldC, const convol_dim *dim, const float *bias_vector, int start_row, int start_col, bool last);
